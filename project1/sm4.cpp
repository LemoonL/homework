...
void sm4::setKey(const uint8_t key[16]) {
    uint32_t MK[4];
    for (int i = 0; i < 4; ++i)
...
void sm4::encryptBlock(const uint8_t in[16], uint8_t out[16]) {
    uint32_t X[36];
    for (int i = 0; i < 4; ++i)
...
void sm4::decryptBlock(const uint8_t in[16], uint8_t out[16]) {
    uint32_t X[36];
    for (int i = 0; i < 4; ++i)
        X[i] = (in[4 * i] << 24) | (in[4 * i + 1] << 16) | (in[4 * i + 2] << 8) | (in[4 * i + 3]);
